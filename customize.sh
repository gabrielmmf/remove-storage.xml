...
#        set_perm dir owner group dirpermission context
  ...
  ui_print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
  ui_print " "
  ui_print "【Remove storage.xml by gabrielmmf】"
  ui_print " This module removes storage.xml for rebooting to recovery mode.  "
  ui_print " Use it if you are having trouble while rebooting to recovery."
  ui_print " "
  ui_print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
